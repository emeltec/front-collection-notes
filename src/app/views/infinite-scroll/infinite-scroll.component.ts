...
import { IMetadata, IProduct, IProductProcess, IProductResponse, MSG_AUTOCOMPLETE_SELECT } from './infinite-scroll.interface';
...
export class InfiniteScrollComponent {
  ...
  ngAfterViewInit(): void {
    this.searchInput.nativeElement.addEventListener(
      'input',
      this.debounce(this.handleInputChange.bind(this), 600)
    );
  ...
  debounce(fn: Function, delay: number): (event: Event) => void {
    let timeoutId: any;
