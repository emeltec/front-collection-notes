...
import { COLORS_MAP, LOGO_SVG, SHAPE_SVG, MARGIN_SECTION, getFormattedDate } from './constants-pdf';
...
export class ExportPdfComponent {
  ...
  generatePDF() {
    const documentDefinition: any = {
      content: [
        ...
        // Sección Proceso de Afiliación
        {
          table: {
            ...
            headerRows: 1,
            body: [
              [{ svg: SHAPE_SVG, }, { text: 'Proceso de afiliación', style: 'SECTION_TITLE', }]
            ]
          },
          layout: 'noBorders',
        },
        ...
        // Sección Datos de la empresa
        {
          table: {
            ...
            headerRows: 1,
            body: [
              [{ svg: SHAPE_SVG, }, { text: 'Datos de la empresa', style: 'SECTION_TITLE', }]
            ]
          },
          layout: 'noBorders',
        },
        ...
        // Sección Datos de afiliación
        {
          table: {
            widths: [15, '*'],
            body: [
              [{ svg: SHAPE_SVG, }, { text: 'Datos de afiliación', style: 'SECTION_TITLE', }]
            ]
          },
          layout: 'noBorders',
        },
      ...
      images: {
        logo: 'data:image/svg+xml;base64,' + btoa(LOGO_SVG)
      }
    };
